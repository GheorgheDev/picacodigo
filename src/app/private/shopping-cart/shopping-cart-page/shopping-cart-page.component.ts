...
import { GameData } from './../../../public/model/game-data';
...
export class ShoppingCartPageComponent implements OnInit {
  ...
  completeShoppingCartData(){
    this.shoppingCardItems.forEach(shoppingCardItem => {
      ...
      this.gameFromShoppingItem = {} as GameData
  ...
  findGameFromShoppingItem(game_id: string) {
    const gameData = this.games.find((game) => game.game_id == game_id);
    if (!!gameData) {
      this.gameFromShoppingItem = gameData;
    }
  }
